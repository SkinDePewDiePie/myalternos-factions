...
<div class="clear"></div>
                ...
                <div class=" tricol-separation" id="showcase">
                    <div class="tricol">
                        <div class="head-skin-classement" data-player=""></div>

                        <h3>Top #1 <b class="froz_color">FACTIONS</b></h3>
                        <ul style="padding-top: 5px;">
                            <h4><b style="color: #555555;">NOM : </b><b class="froz_color">Smooth</b></h4>
                        </ul>
                    </div>
                    ...
                    <div class="tricol">
                        <div class="head-skin-classement" data-player="MelloW41"></div>
